...
XBFのwire contractは[XBF v1 format draft](docs/xbf.md)に記載しています。draftのcodec、durable snapshot path、generation付きfull-snapshot WAL recoveryは提供しますが、DBF/XBF変換はroadmap上の未対応範囲です。
