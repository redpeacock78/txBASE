...
| External secondary-index lifecycle | [Indexes](indexes.md) | Current sidecar maintenance, equality, range, ordered-prefix traversal, candidate-count-ordered equality intersection, and future compound-index planner |
