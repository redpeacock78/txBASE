...
- Strong table representation ETags on successful reads, GET-only If-None-Match validation, and optional If-Match protection for single-table mutations and transactions.
