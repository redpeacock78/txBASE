...
secondary index sidecarの自動更新と単純なequalityおよびrange plannerは実装済みです。ordered sortのplanner、join、aggregation、cursor、multi-record transaction、CJK encoding、XBFはroadmapで検討します。
