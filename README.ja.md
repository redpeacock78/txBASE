...
比較operandには一つの数値operandを持つ`$abs`と、二つの数値operandを持つ`$add`、`$subtract`、`$multiply`、`$divide`、`$mod`を含められます。
...
DBF codecはVisual FoxProのCJK driver IDであるWindows-31J/CP932、GBK/CP936、EUC-KR/CP949、Big5/CP950に加えて、CP932、CP936、CP949、CP950に対応するlegacy dBASEのalias `0x13`、`0x4d`、`0x4e`、`0x4f`にも対応します。
...
- [複数テーブルカタログ](docs/ja/catalog.md)
- [セカンダリインデックスのサイドカー](docs/ja/indexes.md)
- [クエリモデル](docs/ja/query-model.md)
- [集約モデル](docs/ja/aggregation.md)
- [結合モデル](docs/ja/joins.md)
- [クエリ計画](docs/ja/query-planning.md)
- [更新モデル](docs/ja/mutation-model.md)
- [Firebase のデータモデル](docs/ja/firebase-model.md)
- [SQLite のテストと品質](docs/ja/testing-quality.md)
- [品質契約マトリクス](docs/ja/quality-matrix.md)
- [HTTP の意味と QUERY](docs/ja/http-semantics.md)
- [スキーマメタデータとローカル制約](docs/ja/schema-metadata.md)
- [XBF v1 フォーマット草案](docs/ja/xbf.md)
- [ロードマップと明示的な非目標](docs/ja/roadmap.md)
- [仕様調査インデックス](docs/ja/research.md)
