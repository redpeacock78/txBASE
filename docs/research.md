...
| External secondary-index lifecycle | [Indexes](indexes.md) | Current sidecar maintenance, equality, range, equality intersection, and single-field ordered planner plus future multi-key planner |
