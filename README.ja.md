...
secondary index sidecarの自動更新と単純なequality plannerは実装済みです。rangeとsortのplanner、join、aggregation、cursor、multi-record transaction、CJK encoding、XBFはroadmapで検討します。
