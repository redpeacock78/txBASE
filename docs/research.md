...
| Single-table snapshot transactions and isolation | [Snapshot transactions](transactions.md) and [MVCC](mvcc.md) | Current optimistic boundary, catalog HTTP historical reads, plus future serializable work |
