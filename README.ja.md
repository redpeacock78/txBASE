...
- ジャーナル化された`TXRP`サイドカー、再起動時の位置検査、適用済み位置に限定した過去時点フォロワー読み取りを備えた、プロセス内固定termのレプリケーションログ。
...
カタログジャーナル上のプロセス内固定termによるレプリケーションエントリと再生の境界、ジャーナル化された`TXRP`サイドカー、適用済み位置に限定した過去時点フォロワー読み取りも提供します。
ネットワーク転送、クォーラム、コンセンサス、スナップショットインストール、分散フォロワー読み取りの保証は現在のスライスに含みません。
...
- ネットワークレプリケーション、クォーラムまたはコンセンサス、スナップショットインストール、フォロワー読み取り、分散パーティショニング。
