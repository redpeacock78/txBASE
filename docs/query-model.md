...
Chained stages may also use a fresh compound index when the equality fields exactly match the index field order; direct compound joins remain on the nested-loop or hash reference paths.
