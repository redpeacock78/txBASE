...
- Explicit sidecar overrides for those four CJK codecs, with normalized schema output.
...
The sidecar now provides explicit overrides for those same four codecs.
