...
Direct single-key equality joins use a fresh single-field index on the probed table when available and otherwise choose a nested-loop strategy for at most 64 candidate pairs or a hash strategy for larger inputs; full index-aware and merge join planning remain future work.
