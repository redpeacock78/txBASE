...
| Runtime-neutral asynchronous query streaming | [Asynchronous query streaming](async-streaming.md) and [Worker query stream adapter](worker-query-stream.md) | Current polling boundary, native threaded adapter, and Worker-compatible Web Streams adapter; WASI and asynchronous-storage adapters remain future |
