...
- ジャーナル化された`TXRP`サイドカーと再起動時の位置検査を備えた、プロセス内固定termのレプリケーションログ。
...
カタログジャーナル上のプロセス内固定termによるレプリケーションエントリと再生の境界、およびジャーナル化された`TXRP`サイドカーも提供します。
ネットワーク転送、クォーラム、コンセンサス、スナップショットインストール、フォロワー読み取りは現在のスライスに含みません。
