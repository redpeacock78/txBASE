...
プランナーは候補数、インデックス走査、残りのソート作業による有界コストで経路を選び、追加項目でレコード読み取り数とフィルター評価数を公開します。
...
等値積集合では、レコード番号の積集合に使う前に読み取る候補リスト数の推定も含みます。
...
説明には候補レコードの読み取り数とフィルター評価数も含め、等値積集合ではレコード番号の積集合に使う前に読み取る候補リスト数を推定します。
